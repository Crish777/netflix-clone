    ...
    <div className="relative min-h-screen w-full bg-[url('/images/hero1.jpg')] bg-no-repeat bg-center bg-fixed bg-cover">
      <div className="bg-black w-full min-h-screen lg:bg-opacity-50">
        <nav className="px-12 py-5">
          <div className="siteLogo h-12 w-24 bg-[url('/images/logo1.png')] bg-center bg-contain bg-no-repeat" />
        </nav>
            ...
            <div className="flex flex-col gap-4">
              {variant === "register" &&
                <Input
                  ...
                  label="name"
                  onchange={(ev: any) => {
                    setName(lastName => ev.target.value);
                  }}
                  value={name}
                  type="text"
                />}
              <Input
                ...
                label="Email"
                onchange={(ev: any) => {
                  setEmail(lastEmail => ev.target.value);
                }}
                value={email}
                type="email"
              />
              <Input
                ...
                label="Password"
                onchange={(ev: any) => {
                  setPassword(lastpassword => ev.target.value);
                }}
                value={password}
                type="password"
              />
